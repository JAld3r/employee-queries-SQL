...
-- create tables for each CSV file to import data into
...
-- determine which dept number is sales (d007)
...
-- determine which dept numbers are sales and development (d005, d007)
SELECT * from departments
